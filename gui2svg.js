// USAGE: javascript:(function(){document.body.appendChild(document.createElement('script')).src='https://tsunami.he.net/~rawdatas/appslab/oracle/gui2svg.js';})();
...
function waitFor(toTest,toRun){
 if(toTest()){
  ...
  setTimeout(function(){waitFor(toTest,toRun);},499);
 }
}